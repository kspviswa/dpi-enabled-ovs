...
/* Returns the datapath_version column's value in 'row' as a struct ovsdb_datum.
 * This is useful occasionally: for example, ovsdb_datum_find_key() is an
 * easier and more efficient way to search for a given key than implementing
 * the same operation on the "cooked" form in 'row'.
 *
...
/* Returns the mcast_snooping_enable column's value in 'row' as a struct ovsdb_datum.
 * This is useful occasionally: for example, ovsdb_datum_find_key() is an
 * easier and more efficient way to search for a given key than implementing
 * the same operation on the "cooked" form in 'row'.
 *
...
/* Returns the rstp_enable column's value in 'row' as a struct ovsdb_datum.
 * This is useful occasionally: for example, ovsdb_datum_find_key() is an
 * easier and more efficient way to search for a given key than implementing
 * the same operation on the "cooked" form in 'row'.
 *
...
/* Returns the rstp_status column's value in 'row' as a struct ovsdb_datum.
 * This is useful occasionally: for example, ovsdb_datum_find_key() is an
 * easier and more efficient way to search for a given key than implementing
 * the same operation on the "cooked" form in 'row'.
 *
...
void
ovsrec_bridge_set_rstp_status(const struct ovsrec_bridge *row, const struct smap *smap)
{
    struct ovsdb_datum datum;
...
void
ovsrec_ipfix_set_other_config(const struct ovsrec_ipfix *row, const struct smap *smap)
{
    struct ovsdb_datum datum;
...
/* Returns the error column's value in 'row' as a struct ovsdb_datum.
 * This is useful occasionally: for example, ovsdb_datum_find_key() is an
 * easier and more efficient way to search for a given key than implementing
 * the same operation on the "cooked" form in 'row'.
 *
...
/* Returns the rstp_statistics column's value in 'row' as a struct ovsdb_datum.
 * This is useful occasionally: for example, ovsdb_datum_find_key() is an
 * easier and more efficient way to search for a given key than implementing
 * the same operation on the "cooked" form in 'row'.
 *
...
void
ovsrec_port_set_rstp_statistics(const struct ovsrec_port *row, char **key_rstp_statistics, const int64_t *value_rstp_statistics, size_t n_rstp_statistics)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
ovsrec_port_set_rstp_status(const struct ovsrec_port *row, const struct smap *smap)
{
    struct ovsdb_datum datum;
